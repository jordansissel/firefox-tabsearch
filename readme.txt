...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\tabsearch on
     Windows, /home/user/dev/tabsearch on Linux) in a file named
     tabsearch@jordan.sissel and copy that file to
